...
export namespace EventTypeImportOpenApiInUtil {
  export function _fromJsonObject(object: any): EventTypeImportOpenApiIn {
    return {
  ...
  export function _toJsonObject(self: EventTypeImportOpenApiIn): any {
    return {
      dryRun: self.dryRun,
